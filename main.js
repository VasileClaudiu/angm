...
/* harmony import */ var _forgotpass_forgotpass_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./forgotpass/forgotpass.component */ "./src/app/forgotpass/forgotpass.component.ts");
...
var routes = [
    ...
    {
        path: 'forgotpass',
        component: _forgotpass_forgotpass_component__WEBPACK_IMPORTED_MODULE_7__["ForgotpassComponent"]
    },
    {
        path: 'dashboard',
...
module.exports = "<div id=\"divapp\" style=\"background-color: {{globals.colorbackground}};\">\n<!--The content below is only a placeholder and can be replaced.-->\n<div style=\"text-align:center\">\n<h2>\n   <strong>Welcome to Home Page {{ title }}!!</strong>\n</h2>\n <app-menu></app-menu>\n</div>\n<hr>\n<div class=\"wrapper\">\n\t<div class=\"container\">\n\t\t<div>\n\t      <h2>{{ 'HOME.TITLE' | translate }}</h2>\n\t      <label class=\"mr-sm-2\">\n\t        {{ 'HOME.SELECT' | translate }}\n\t        <select  class=\"custom-select mr-sm-2\" #langSelect (change)=\"translate.use(langSelect.value)\">\n\t          <option *ngFor=\"let lang of translate.getLangs()\" [value]=\"lang\" [selected]=\"lang === translate.currentLang\">{{ lang }}</option>\n\t        </select>\n\t      </label>\n\t    </div>\n\t\t<div class=\"text-center bgblue\" *ngIf=\"this.globals.showLoading\" style=\"position:relative;z-index: 9;\">Please Wait...Loading Page...<div class=\"spinner\"></div></div>\n\t\t<router-outlet></router-outlet>\n\t</div>\n</div>\n</div>"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(globals, router, translate) {
        var _this = this;
        ...
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(1000)).subscribe(function (routerEvent) {
            _this.globals.showLoading = false;
        });
        translate.addLangs(['en', 'fr', 'ro']);
        translate.setDefaultLang('en');
        var browserLang = translate.getBrowserLang();
        translate.use(browserLang.match(/en|fr|ro/) ? browserLang : 'en');
    }
    AppComponent.prototype.ngOnInit = function () {
        //$() = this.globals.colorbackground;
        jquery__WEBPACK_IMPORTED_MODULE_5__('body').css('background-color', this.globals.colorbackground);
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_globals__WEBPACK_IMPORTED_MODULE_3__["Globals"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _authguard_guard__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./authguard.guard */ "./src/app/authguard.guard.ts");
...
/* harmony import */ var _forgotpass_forgotpass_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./forgotpass/forgotpass.component */ "./src/app/forgotpass/forgotpass.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _forgotpass_forgotpass_component__WEBPACK_IMPORTED_MODULE_19__["ForgotpassComponent"],
            ...
            providers: [
                ...
                _globals__WEBPACK_IMPORTED_MODULE_10__["Globals"],
                _user_service__WEBPACK_IMPORTED_MODULE_13__["UserService"],
                _authguard_guard__WEBPACK_IMPORTED_MODULE_12__["AuthguardGuard"]
            ],
...
var AuthguardGuard = /** @class */ (function () {
    ...
    AuthguardGuard.prototype.canActivate = function (next, state) {
        ...
        if (this.user.getUserLoggedIn() === false) {
            console.log('You are not Is user logged in?');
            this.router.navigate(['/']);
        }
        ...
        else if (this.user.getUserLoggedIn() != 'true') {
            console.log('You are not authenticated');
            return false;
        }
    };
...
module.exports = "<div class=\"dash\">\n\t<a class=\"{{globals.colorbutton}}\" routerLink=\"/announce\">Create Announce</a>\n\t<table class=\"table stripe\">\n\t\t<thead><tr><th>Title</th><th>Desciption</th><th>Body</th><th>Price</th><th>Image ID</th><th>User ID</th><th>Category ID</th></tr></thead>\n\t\t<tbody><tr *ngFor=\"let anounce of anounces; let i = index\"><td>{{anounce.title}}</td><td>{{anounce.description}}</td><td>{{anounce.body}}</td><td>{{anounce.price}}</td><td>{{anounce.image_id}}</td><td>{{anounce.user_id}}</td><td>{{anounce.category_id}}</td></tr></tbody>\n\t</table>\n\t<div>\n\t\t<div class=\"app flex-row align-items-center\">   \n\t\t    <div class=\"container\">\n\t\t\t\t<div class=\"row mt-3\">\n\t\t            <div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12\" *ngFor=\"let anouncef of anounces; let i = index\">\n\t\t                <div class=\"card mt-3\">\n\t\t                \t<div class=\"card-header\">\n\t\t                \t\t<div class=\"product-title\">\n\t\t\t\t\t\t\t\t\t{{anouncef.title}}\n\t\t\t\t\t\t\t\t</div>\n\t\t                \t</div>\n\t\t                \t<div class=\"card-body\">\n\t\t\t\t\t\t\t\t<div class=\"product-img\">\n\t\t\t\t\t\t\t\t\t{{anouncef.image_id}}\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"product-category\">\n\t\t\t\t\t\t\t\t\t{{anouncef.category_id}}\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"product-description\">\n\t\t\t\t\t\t\t\t\t{{anouncef.description}}\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"product-price\">\n\t\t\t\t\t\t\t\t\t{{anouncef.price}}\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<hr />\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n<p>\n  You are authenticated. Hello {{name}}\n</p>\n  <a class=\"{{globals.colorbutton}}\" routerLink=\"/\">Go back</a>&nbsp;&nbsp;<a class=\"{{globals.colorbutton}}\" href=\"\" (click)=\"logout()\">Logout</a>\n\n</div>\n"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(user, router, globals, httpc) {
        this.user = user;
        this.router = router;
        this.globals = globals;
        this.httpc = httpc;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        var newheader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
        ...
        setTimeout(function () {
            var _this = this;
            this.httpc.get(this.globals.base_url + '/api/anounces', { headers: newheader })
                .subscribe(function (res) {
                //alert(JSON.stringify(res));
                _this.anounces = res['response'];
                _this.globals.showLoading = false;
            });
        }.bind(this), 500);
    };
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _globals__WEBPACK_IMPORTED_MODULE_4__["Globals"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
    ], DashboardComponent);
...
module.exports = "<br />\n<div class=\"col-md-6 col-lg-6 offset-2\">\n\t<div class=\"text-center\"><h2><strong>Forgot Password Page</strong></h2></div>\n\t<hr>\n\t<form class=\"form-control {{globals.colorformbg}}\" [formGroup]=\"form\" (submit)=\"Forgotpass($event)\">\n\t\t\t<div class=\"input\">\n\t\t\t\t<label><strong>Email:</strong></label>\n\t\t\t\t<input class=\"form-control\" type=\"email\" name=\"email\" placeholder=\"Please enter your email\" />\n\t\t\t</div>\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"input col-lg-3\">\n\t\t\t\t\t<input class=\"{{globals.colorbutton}}\" type=\"submit\" value=\"Submit\" [disabled]=\"!form.valid\"/>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"input col-lg-6\">\n\t\t\t\t\t<button class=\"{{globals.colorbutton}}\" (click)=\"goback($event)\">Go back</button>\n\t\t\t\t</div>\n\t\t\t</div>\n\t</form>\n</div>\n"

/***/ }),

/***/ "./src/app/forgotpass/forgotpass.component.scss":
/*!******************************************************!*\
  !*** ./src/app/forgotpass/forgotpass.component.scss ***!
  \******************************************************/
/*! no static exports found */
...
var ForgotpassComponent = /** @class */ (function () {
    function ForgotpassComponent(http, fb, globals) {
        this.http = http;
        this.fb = fb;
        this.globals = globals;
        this.token = '';
    ...
    ForgotpassComponent.prototype.Forgotpass = function (e) {
        var _this = this;
        e.preventDefault();
        console.log(e);
        console.log('teest!!');
        ...
        if (!email) {
            ...
            console.log(email);
            this.http.get('http://188.226.174.88/apliccoin/api/auth/token?email=' + email)
                .subscribe(function (data) {
                //alert(JSON.stringify(data));
                _this.token = JSON.stringify(data);
                if (_this.token) {
    ...
    ForgotpassComponent.prototype.goback = function (e) {
        e.preventDefault();
        window.history.back();
    };
    ForgotpassComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./forgotpass.component.scss */ "./src/app/forgotpass/forgotpass.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _globals__WEBPACK_IMPORTED_MODULE_3__["Globals"]])
    ], ForgotpassComponent);
...
var Globals = /** @class */ (function () {
    function Globals() {
        this.baseang_url = 'http://localhost/anganunt/dist';
        this.base_url = 'http://localhost/anganunt/capianganunt';
        this.showLoading = true;
        this.role = 'test';
        this.islogin = false;
        this.image_upload = [];
        this.colorbutton = 'btn btn-blue-grey waves-light';
        this.colorbackground = 'silver';
        this.colorformbg = 'pink';
...
module.exports = "<br/>\n<div class=\"col-md-6 col-lg-6 offset-2\">\n<form novalidate [formGroup]=\"loginForm\" (submit)=\"loginUser($event)\" class=\"ui form  {{globals.colorformbg}}\">  \n\t<div class=\"text-center\"><h2><strong>Login Page</strong></h2></div>\n\t<hr>\n\t<fieldset>\n\t<div *ngIf=\"!loginForm.valid && divhide==true\" class=\"ui error message\">Invalid User or Password</div>\n\t<div class=\"input\">\n\t\t<label><strong>Username:</strong></label>\n\t\t<div>\n\t\t<input class=\"form-control\" type=\"text\" name=\"username\" placeholder=\"Please enter your Username\" formControlName=\"username\" id=\"username\" ng-minlength=\"3\" />\n\t\t<div *ngIf=\"!username.valid\"  class=\"ui error message\">Please enter your User Name</div>  \n    \t<div *ngIf=\"username.hasError('required')\"></div>\n\t\t</div>\n\t</div>\n\t</fieldset>\n\t<fieldset>\n\t<div class=\"input\">\n\t\t<label><strong>Password:</strong></label>\n\t\t<div>\n\t\t<input class=\"form-control\" type=\"password\" name=\"password\" placeholder=\"Please enter your password\" formControlName=\"password\" id=\"password\" ng-minlength=\"3\" />\n\t\t<div *ngIf=\"!password.valid\"  class=\"ui error message\">Please enter your Password</div>  \n    \t<div *ngIf=\"password.hasError('required')\"></div>\n\t\t</div>\n\t</div>\n\t</fieldset>\n\t<br/>\n\t<div class=\"row\">\n\t\t<div class=\"input col-lg-3\" style=\"margin-right: -20px;\">\n\t\t\t<input class=\"{{globals.colorbutton}}\" type=\"submit\" value=\"Login\" name=\"login\" [disabled]=\"!loginForm.valid\" />\n\t\t</div>\n\t\t<div class=\"input col-lg-3\">\n\t\t\t<button class=\"{{globals.colorbutton}}\" routerLink=\"/register\" name=\"register\">Register</button>\n\t\t</div>\n\t\t<div class=\"input col-lg-6\">\n\t\t\t<button class=\"{{globals.colorbutton}}\" routerLink=\"/forgotpass\" name=\"forgotpass\">Forgot Password</button>\n\t\t</div>\n\t</div>\n</form>\n</div>"
...
var LoginFormComponent = /** @class */ (function () {
    function LoginFormComponent(fb, httpc, user, router, globals) {
        this.fb = fb;
        this.httpc = httpc;
        this.user = user;
        this.router = router;
        this.globals = globals;
        //private sendheaders = new HttpHeaders({'Access-Control-Allow-Origin':'*','Content-Type':  'application/json'});
        this.sendheaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        this.createForm();
    }
    ...
    LoginFormComponent.prototype.loginf = function (username, userpassword) {
        var _this = this;
        //this.httpc.post('http://localhost/angtasks/capiangtasks/api/login?user='+username+'&password='+userpassword,JSON.stringify({user: username, password: userpassword}),{headers: this.sendheaders})
        var body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]()
            .set('user', username)
            .set('password', userpassword);
        console.log(this.sendheaders.get('Content-Type'));
        this.httpc.post(this.globals.base_url + '/api/login', body.toString(), { headers: this.sendheaders })
            .toPromise()
            .then(function (res) {
            ...
            if (_this.token) {
                ...
                var newheader_1 = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                    'Access-Control-Allow-Origin': '*',
                    'Authorization': 'Bearer ' + _this.token,
                    'Content-Type': 'application/x-www-form-urlencoded'
                });
                //this.sendheaders=this.sendheaders.append('Access-Control-Allow-Origin','*');
                //this.sendheaders=this.sendheaders.append('Authorization','Bearer ' + this.token);
                //newheader=newheader.append('Authorization','Bearer '+this.token);
                //newheader=newheader.append('Content-Type','application/json');
                //newheader=newheader.append('Access-Control-Allow-Origin','*');
                //console.log(newheader.get('Content-Type'));
                console.log(newheader_1.get('Authorization'));
                //console.log(newheader.get('Access-Control-Allow-Origin'));
                //this.httpc.get('http://localhost/angtasks/capiangtasks/api/login',{headers:new HttpHeaders({'Access-Control-Allow-Origin':'*','Content-Type':'application/json','Authorization':'Bearer '+this.token})})
                setTimeout(function () {
                    var _this = this;
                    this.httpc.get(this.globals.base_url + '/api/login', { headers: newheader_1 })
                        .subscribe(function (res) {
    ...
    LoginFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _globals__WEBPACK_IMPORTED_MODULE_5__["Globals"]])
    ], LoginFormComponent);
...
module.exports = "<mat-card>\n\t<mat-card-title>\n\t\tAngular Tasks {{ globals.role }} {{ globals.islogin }} {{ globals.colorbackground }}\n\t</mat-card-title>\n\t<mat-card-content>\n\t\t<button mat-raised-button class=\"{{ globals.colorbutton }}\" [matMenuTriggerFor]=\"appMenu\">\n\t\t  <mat-icon>more_vert</mat-icon>\n\t\t</button>\n\t\t<button mat-raised-button class=\"{{ globals.colorbutton }} menu\" [matMenuTriggerFor]= \"appMenu\" style=\"margin-top: 0;font-size: 1.4em;\">\n\t\t\tOpen menu\n\t\t</button>\n\t\t<mat-menu class=\"{{ globals.colorbutton }}\" #appMenu=\"matMenu\">\n\t\t\t<div *ngIf=\"globals.islogin==false\">\t\n\t\t\t<button  class=\"{{ globals.colorbutton }} col-md-11\" mat-menu-item routerLink=\"\">\n\t\t\t\t<mat-icon>home</mat-icon>\n\t\t\t\t<span>{{'HOME.home' | translate }}</span>\n\t\t\t</button>\n\t\t\t</div>\n\t\t\t<div *ngIf=\"globals.islogin==true\">\t\n\t\t\t<button  class=\"{{ globals.colorbutton }} col-md-11\" mat-menu-item routerLink=\"dashboard\">\n\t\t\t\t<mat-icon>home</mat-icon>\n\t\t\t\t<span>&nbsp;{{'HOME.home' | translate }}</span>\n\t\t\t</button>\n\t\t\t</div>\n\t\t\t<div *ngIf=\"globals.islogin==true\">\n\t\t\t<button  class=\"{{ globals.colorbutton }} col-md-11\" mat-menu-item routerLink=\"tasks\">\n\t\t\t\t<mat-icon>assignment_turned_in</mat-icon>\n\t\t\t\t<span>&nbsp;{{'HOME.tasks' | translate }}</span>\n\t\t\t</button>\n\t\t\t<button  class=\"{{ globals.colorbutton }} col-md-11\" mat-menu-item routerLink=\"settings\">\n\t\t\t\t<mat-icon>settings</mat-icon>\n\t\t\t\t<span>&nbsp;{{'HOME.settings' | translate }}</span>\n\t\t\t</button>\n\t\t\t<button  class=\"{{ globals.colorbutton }} col-md-11\" mat-menu-item (click)=\"logout()\">\n\t\t\t\t<mat-icon><span><i class=\"fa fa-sign-in\" style=\"font-size: 1em;\"></i></span></mat-icon>\n\t\t\t\t<span>&nbsp;{{'HOME.logout' | translate }}</span>\n\t\t\t</button>\n\t\t\t</div>\n\t\t\t<div *ngIf=\"globals.islogin==false\">\n\t\t\t<button  class=\"{{ globals.colorbutton }} col-md-11\" mat-menu-item routerLink=\"register\">\n\t\t\t\t<mat-icon><span><i class=\"fa fa-user-plus\" style=\"font-size: 1em;\"></i></span></mat-icon>\n\t\t\t\t<span>&nbsp;{{'HOME.register' | translate }}</span>\n\t\t\t</button><br />\n\t\t\t<button  class=\"{{ globals.colorbutton }} col-md-11\" mat-menu-item routerLink=\"login\">\n\t\t\t\t<mat-icon><span><i class=\"fa fa-sign-in\" style=\"font-size: 1em;\"></i></span></mat-icon>\n\t\t\t\t<span>&nbsp;{{'HOME.login' | translate }}</span>\n\t\t\t</button>\n\t\t\t</div>\n\t\t</mat-menu>\n\t</mat-card-content>\n</mat-card>\n"
...
var MenuComponent = /** @class */ (function () {
    function MenuComponent(user, router, globals) {
        this.user = user;
        this.router = router;
        this.globals = globals;
        this.islogin = false;
    ...
    MenuComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _globals__WEBPACK_IMPORTED_MODULE_3__["Globals"]])
    ], MenuComponent);
...
module.exports = "<br />\n<div class=\"col-md-6 col-lg-6 offset-2\">\n\t<form [formGroup]=\"regForm\" (submit)=\"RegisterUser($event)\" class=\"{{globals.colorformbg}}\" >\n\t\t\t<div class=\"text-center\"><h2><strong>Register Page</strong></h2></div>\n\t\t\t<hr>\n\t\t\t<fieldset>\n\t\t\t<div class=\"input\">\n\t\t\t\t<label><strong>Username:</strong></label>\n\t\t\t\t<input class=\"form-control\" type=\"text\" name=\"username\" placeholder=\"Please enter your username\"  ng-minlength=\"3\" />\n\t\t\t\t<div *ngIf=\"!username.valid\"  class=\"ui error message\">Please enter your Username</div>  \n    \t\t\t<div *ngIf=\"username.hasError('required')\"></div>\n\t\t\t</div>\n\t\t\t</fieldset>\n\t\t\t<fieldset>\n\t\t\t<div class=\"input\">\n\t\t\t\t<label><strong>Email:</strong></label>\n\t\t\t\t<input class=\"form-control\" type=\"email\" name=\"email\" placeholder=\"Please enter your email\"  ng-minlength=\"3\" />\n\t\t\t\t<div *ngIf=\"!email.valid\"  class=\"ui error message\">Please enter your Email Adress</div>  \n    \t\t\t<div *ngIf=\"email.hasError('required')\"></div>\n\t\t\t</div>\n\t\t\t</fieldset>\n\t\t\t<fieldset>\n\t\t\t<div class=\"input\">\n\t\t\t\t<label><strong>Password:</strong></label>\n\t\t\t\t<input class=\"form-control\" type=\"password\" id=\"password\" name=\"passwords\" formControlName=\"passwords\" placeholder=\"Please enter your password\"  ng-minlength=\"3\" />\n\t\t\t\t<div *ngIf=\"!password.valid\"  class=\"ui error message\">Please enter your Password</div>  \n    \t\t\t<div *ngIf=\"username.hasError('required')\"></div>\n\t\t\t</div>\n\t\t\t</fieldset>\n\t\t\t<fieldset>\n\t\t\t<div class=\"input\">\n\t\t\t\t<label><strong>Repeat Password:</strong></label>\n\t\t\t\t<input class=\"form-control\" type=\"password\" id=\"confirmPassword\" name=\"confirmpasswords\" formControlName=\"confirmpasswords\"  placeholder=\"Please re-enter your password\" ng-minlength=\"3\" />\n\t\t\t\t<div *ngIf=\"!confirmPassword.valid\"  class=\"ui error message\">Please enter your Repeat Password</div>  \n    \t\t\t<div *ngIf=\"confirmPassword.hasError('required')\"></div>\n\t\t\t</div>\n\t\t\t</fieldset>\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"input col-lg-3\">\n\t\t\t\t\t<input class=\"{{globals.colorbutton}}\" type=\"submit\" value=\"register\" [disabled]=\"!regForm.valid\" />\n\t\t\t\t</div>\n\t\t\t\t<div class=\"input col-lg-6\">\n\t\t\t\t\t<button class=\"{{globals.colorbutton}}\" (click)=\"goback($event)\">Go back</button>\n\t\t\t\t</div>\n\t\t\t</div>\n\t</form>\n</div>"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(http, fb, globals) {
        this.http = http;
        this.fb = fb;
        this.globals = globals;
        this.token = '';
        this.sendheaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        this.createForm();
    }
    ...
    RegisterComponent.prototype.RegisterUser = function (e) {
        ...
        var useremail = e.target.elements[1].value;
        var userpassword = e.target.elements[2].value;
    };
    RegisterComponent.prototype.goback = function (e) {
        e.preventDefault();
        window.history.back();
    };
...
module.exports = "<br/>\n<div class=\"col-md-6 col-lg-6 offset-2 {{globals.colorformbg}}\">\n<form>\n<mat-form-field>\n  <mat-select placeholder=\"Favorite form color\" name=\"formsel\" [(ngModel)]=\"formsel\">\n    <mat-option *ngFor=\"let formsel of formssel\" [value]=\"formsel.value\">\n      {{ formsel.viewValue }}\n    </mat-option>\n  </mat-select>\n</mat-form-field><button class=\"{{globals.colorbutton}}\" name=\"formselb\" (click)=\"setformselected($event)\">Select Form color</button><br />\n<mat-form-field>\n  <mat-select placeholder=\"Favorite button color\" name=\"buttonsel\" [(ngModel)]=\"buttonsel\">\n    <mat-option *ngFor=\"let buttonsel of buttonssel\" [value]=\"buttonsel.value\">\n      {{ buttonsel.viewValue }}\n    </mat-option>\n  </mat-select>\n</mat-form-field><button class=\"{{globals.colorbutton}}\" name=\"formselb\" (click)=\"setbuttonselected($event)\">Select Buttom color</button><br />\n<mat-form-field>\n  <mat-select placeholder=\"Favorite background color\" name=\"bgsel\" [(ngModel)]=\"bgsel\">\n    <mat-option *ngFor=\"let bgsel of bgssel\" [value]=\"bgsel.value\">\n      {{ bgsel.viewValue }}\n    </mat-option>\n  </mat-select>\n</mat-form-field><button class=\"{{globals.colorbutton}}\" name=\"bgselb\" (click)=\"setbgselected($event)\">Select background color</button>\n</form>\n</div>"
...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(globals) {
        this.globals = globals;
        this.formssel = [
        ...
        this.buttonssel = [
            { value: 'btn btn-blue-grey waves-light', viewValue: 'Grey' },
            { value: 'btn btn-primary waves-light', viewValue: 'Blue' },
            { value: 'btn btn-secondary waves-light', viewValue: 'Secondary' },
            { value: 'btn btn-success waves-light', viewValue: 'Success' },
            { value: 'btn btn-warning waves-light', viewValue: 'Warning' },
            { value: 'btn btn-info waves-light', viewValue: 'Info' },
            { value: 'btn btn-light waves-light', viewValue: 'Light' },
            { value: 'btn btn-dark waves-light', viewValue: 'Dark' },
            { value: 'btn btn-danger waves-light', viewValue: 'Red' },
            { value: 'btn btn-info waves-light', viewValue: 'Pink' }
        ];
    }
    SettingsComponent.prototype.ngOnInit = function () {
    };
    SettingsComponent.prototype.setformselected = function (e) {
        e.preventDefault();
        //alert("form selected!!"+this.formsel);
        this.globals.colorformbg = this.formsel;
    };
    SettingsComponent.prototype.setbuttonselected = function (e) {
        e.preventDefault();
        //alert("button selected!!"+this.buttonsel);
        this.globals.colorbutton = this.buttonsel;
    };
    SettingsComponent.prototype.setbgselected = function (e) {
        e.preventDefault();
        //alert("button selected!!"+this.buttonsel);
        this.globals.colorbackground = this.bgsel;
        /*setTimeout(()=>{
        this.router.navigated = false;
        this.router.navigate([this.router.url]);
        alert('S-a facut!!');
        },500);*/
        jquery__WEBPACK_IMPORTED_MODULE_2__('body').css('background-color', this.globals.colorbackground);
        jquery__WEBPACK_IMPORTED_MODULE_2__('mat-card.mat-card').css('background-color', this.globals.colorbackground);
    };
...
module.exports = __webpack_require__(/*! G:\xampp7\htdocs\angm\src\main.ts */"./src/main.ts");
